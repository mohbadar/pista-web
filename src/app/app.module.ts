...
import { GestureConfig, MatProgressSpinnerModule, MAT_DIALOG_DEFAULT_OPTIONS } from '@angular/material';
...
import { NgbDateAdapter, NgbDateParserFormatter, NgbTimeAdapter, NgbCalendar, NgbCalendarPersian, NgbDatepickerI18n } from '@ng-bootstrap/ng-bootstrap';
    ...
    return (): Promise<any> => {
        return new Promise(async (resolve, reject) => {
            try {
                ...
                this.principal = new Principal(keycloak.isLoggedIn(), keycloak.getUserRoles(), []);
